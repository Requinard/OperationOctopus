...
namespace ICT4EVENT
{
    ...
    public class RentableReservationModel : DBModel, IDataModelUpdate
    {
        ...
        ///     The rentable.
        /// </summary>
        private RentableObjectModel rentable;
        ...
        /// <summary>
        ///     Gets or sets the rentable.
        /// </summary>
        public RentableObjectModel Rentable
        {
            get { return this.rentable; }

            set { this.rentable = value; }
        }
        ...
        public bool Destroy()
        {
            string finalQuery = string.Format(DESTROYSTRING2, "RESERVATION", "'" + this.Rentable.Id + "'");
            OracleDataReader reader = DBManager.QueryDB(finalQuery);
        ...
        public void ReadFromReader(OracleDataReader reader)
        {
            ...
            user.Read();
            this.rentable.Id = Convert.ToInt32(reader["ItemID"].ToString());
            this.rentable.Read();
